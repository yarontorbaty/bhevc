...
typedef struct AV1_COMP {
  ...
  /*!
   * Brain-inspired temporal ON/OFF change map. Per MI unit (4x4 block):
   *   0 = TEMPORAL_STABLE, 1 = TEMPORAL_ON, 2 = TEMPORAL_OFF.
   * Computed once per frame from source vs last_source difference.
   */
  uint8_t *temporal_change_map;

  /*!
   * Allocated size for |temporal_change_map|.
   */
  int temporal_change_map_alloc_size;
